        ...
        _createClass(_LoginComponent, [{
          ...
          value: function onLoginSubmit() {
            ...
            this.authService.login(user).subscribe(function (token) {
              var decoded = (0, jwt_decode__WEBPACK_IMPORTED_MODULE_0__["default"])(token.token); //Check if response was a success or error
              ...
              if (!token.success) {
                ...
                if (_this.authService.CurrentlyloggedIn()) {
                  _this.authService.loggingIn(decoded.role);
                } else {
